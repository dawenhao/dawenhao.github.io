...
*@author ...
*/
//class Core.MusicCore
var MusicCore=(function(){
	function MusicCore(){}
	__class(MusicCore,'Core.MusicCore');
	var __proto=MusicCore.prototype;
	__proto.Init=function(){
		AudioManager.Instance().Init();
	}

	__proto.Dispose=function(){}
	MusicCore.Instance=function(){
		if (MusicCore._instance==null){
			MusicCore._instance=new MusicCore();
		}
		return MusicCore._instance;
	}

	MusicCore._instance=null;
	return MusicCore;
})()
